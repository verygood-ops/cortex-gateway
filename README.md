...
| `-gateway.auth.jwt-validation-algo` | Use HMAC or RSA for JWT verification | "HMAC" |
...
An expiration claim is optional, but when provided, it will be validated by Cortex Gateway.
